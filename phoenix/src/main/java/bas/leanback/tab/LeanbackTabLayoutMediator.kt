...
class LeanbackTabLayoutMediator(
    ...
    private var viewPagerSmoothScroll: Boolean = true
) {
    ...
    init {
        onTabSelectedListener = ViewPagerOnTabSelectedListener(viewPager, viewPagerSmoothScroll)
    ...
    fun setViewPagerSmoothScroll(smooth: Boolean) {
        viewPagerSmoothScroll = smooth
        onTabSelectedListener.viewPagerSmoothScroll = smooth
    }
     ...
     */
    internal class ViewPagerOnTabSelectedListener(
        private val viewPager: ViewPager,
        var viewPagerSmoothScroll: Boolean
    ) :
        TabLayout.OnTabSelectedListener {
        override fun onTabSelected(tab: TabLayout.Tab) {
            viewPager.setCurrentItem(tab.position, viewPagerSmoothScroll)
        }
