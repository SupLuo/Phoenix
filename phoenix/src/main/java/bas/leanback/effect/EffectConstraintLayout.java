 ...
 */
public class EffectConstraintLayout extends ConstraintLayout implements EffectLayoutDelegate.Callback {
  private final EffectLayoutDelegate effectDelegate;

  public EffectConstraintLayout(@NonNull Context context) {
    this(context,(AttributeSet) null);
  }

  public EffectConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
  ...
  public EffectConstraintLayout(@NonNull Context context, @NonNull EffectParams effectParams) {
    super(context);
