 ...
 */
public class EffectFrameLayout extends FrameLayout implements EffectLayoutDelegate.Callback {
  private final EffectLayoutDelegate effectDelegate;

  public EffectFrameLayout(@NonNull Context context) {
    this(context,(AttributeSet) null);
  }

  public EffectFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
  ...
  public EffectFrameLayout(@NonNull Context context, @NonNull EffectParams effectParams) {
    super(context);
