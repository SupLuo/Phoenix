 ...
 * 闪光效果
 */
class EffectParams internal constructor(builder: Builder) {

    /*是否启用扫光动画*/
    var shimmerEnabled: Boolean = DEFAULT_SHIMMER_ENABLED
        private set
        get() = false //todo 为了效率 目前强制去掉扫光动画
    ...
    var pressStateEnable: Boolean = true
    ...
    init {
        ...
        this.pressStateEnable = builder.pressStateEnable
        this.containsSurfaceChild = builder.containsSurfaceChild
    ...
    data class Builder(
        ...
        constructor(
            ...
            val ta =
                context.obtainStyledAttributes(
                    attrs,
                    R.styleable.LeanbackEffectLayout,
                    defStyleAttr,
                    0
                )
            shimmerEnabled =
                ta.getBoolean(R.styleable.LeanbackEffectLayout_shimmer_bas, shimmerEnabled)
            shimmerColor =
                ta.getColor(R.styleable.LeanbackEffectLayout_shimmerColor_bas, shimmerColor)
            ...
            strokeWidth =
                ta.getDimension(R.styleable.LeanbackEffectLayout_strokeWidth_bas, strokeWidth)
            ...
            pressStateEnable = ta.getBoolean(
                R.styleable.LeanbackEffectLayout_pressStateEnable_bas,
                pressStateEnable
            )

            containsSurfaceChild = ta.getBoolean(
                R.styleable.LeanbackEffectLayout_effect_contains_surface_child_bas,
                containsSurfaceChild
            )
            val excludesIds =
        ...
        fun setAllCorner(cornerSize: Float):Builder {
